...
int main() {
  ...
  // Disable strict timestamp order by setting the grace period to a nonzero value 
  // This is slightly slower (which may be unsuited for real-time applications!), but logs will appear in order 
